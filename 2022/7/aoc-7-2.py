...
root_size = dirs["/"]
required_to_free = root_size + required_size - total_size
# want smallest dir bigger than or equal to this
candidates = filter(lambda x: x[1] >= required_to_free, dirs.items())
